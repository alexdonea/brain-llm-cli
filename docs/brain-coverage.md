# How much of the human brain does brain-lmm cover? (+ does it have a survival instinct?)
...
includes, and how AI cognitive architectures estimate "brain coverage"; then mapped brain-lmm's 30
`brain.py` sections + runtime stores against that taxonomy.

**Honesty framing.** brain-lmm models the *function* of a feeling, remembering, self-regulating mind —
...
loops (LeDoux; Fanselow/Mobbs threat-imminence; Craig/Damasio interoception). brain-lmm has the building
...
|---|---|
| The **affective-memory / emotional / social mind** brain-lmm targets | **~75–85% by breadth, ~55–65% by depth** |
...
brain-lmm is a genuinely **broad, literature-grounded model of the affective-memory mind**: within the
