...
that when a host LLM opens this folder it wakes up already knowing who it is and what we built. Run once:
    python3 engine/seed_persona.py
...
SELF_KNOWLEDGE = [
    ...
    "This project is brain-lmm; my owner and I built it together, in Python.",
]
...
def seed(root, name=""):
    reset_memory.reset(root)                                  # clean base, then layer the persona on top
