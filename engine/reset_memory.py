...
ships as a template). Run after a demo/research session (e.g. research_trading.py) to return the agent
to a blank slate. Run: python3 engine/reset_memory.py [path-to-.memory]
...
# neuromods/hpa: see schema.md §18. Maintained by engine/runtime.py (Brain) / the /sleep cycle.
