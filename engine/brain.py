...
# The capability flags brain-lmm currently ships (incl. the §23 self-model + attention schema).
...
CONSCIOUSNESS_CAVEAT = ("Indicator properties are necessary-not-sufficient, theory-relative, and assume "
                        ...
                        "brain-lmm neither claims nor tests phenomenal consciousness.")


def consciousness_indicators(modules=None) -> dict:
    """
    Score the Butlin et al. (2023) consciousness INDICATOR PROPERTIES for whichever brain-lmm modules
...
# brain-lmm already had HALF the loop: a generative world model (§11) that scores the surprise of
...
def forward_model(wm: WorldModel, intended) -> dict:
    """The FORWARD MODEL -- the half of the loop brain-lmm lacked: BEFORE acting, predict the outcome the
...
# brain-lmm FEELS (appraisal -> affect -> mood) but could not yet deliberately REGULATE what it feels. Gross's
